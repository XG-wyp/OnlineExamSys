...
public class PaperDetailsFrm extends AFrame {

	public PaperDetailsFrm() {
		super.init();
	}
	...
	private JButton btnMistake;// 错题集
	...
	public ExamListFrm listFrm = null;
	...
	public void loadData() {
		...
		if (!this.getTitle().contains("查看")) {
			this.setTitle(
					this.getTitle() + "--> 正在查看学生【" + stu.getNickName() + "】的【" + paper.getSubjectName() + "】考试信息");
		}
	...
	public void showItemInit(Long qType) {
		...
		btnMistake.setText("错题集");
		btnMistake.setBounds(365, 500, 80, 30);
		container.add(btnMistake);
	...
	protected void initEvent() {
		...
		btnMistake.addActionListener(e -> {
			btnMistake_click(e);
		});
	}

	private void btnMistake_click(ActionEvent e) {
		// TODO Auto-generated method stub
		MistakeCollectionFrm frm = new MistakeCollectionFrm();
		frm.pk = pk;
		frm.detailFrm = this;
		frm.loadData();
		frm.setVisible(true);
