...
public class QuestionUpdateFrm1 extends JFrame {
	// 9
	...
	public QuestionUpdateFrm0 updateFrm0 = null;
	public Long qType;
	public Long subjectId;
	public String subjectName;

	public QuestionUpdateFrm1() {
		initUI();
		customLoad();
	}
...
//		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	public void reFlash() {
		if (qType == 1) {
			this.setTitle("修改题目-" + subjectName + "-判断题");
			judgeInitUI();
		} else if (qType == 2) {
			this.setTitle("修改题目-" + subjectName + "-选择题");
			choiseInitUI();
		}
