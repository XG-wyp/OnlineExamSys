 ...
 *
 */
public class PaperUpdateFrm2 extends JFrame {
...
//		lblMsg.setText("提示信息");
	...
	private void btnSubmit_click(ActionEvent e) {
		...
		bean.setPerScore(totalScore / bean.getQuestionNum());
		try {
