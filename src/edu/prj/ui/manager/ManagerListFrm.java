...
public class ManagerListFrm extends JFrame {
	...
	private void showListData() {
		...
		list = managerService.listByName(loginName, nickName);
		ATableModel<Manager> tableModel = null;
		tableModel = new ATableModel<Manager>(list, 5) {

			@Override
			public Object getPropValue(Manager arg0, int arg1) {
				// TODO Auto-generated method stub
				if (arg1 == 0) {
					return arg0.getId();
				} else if (arg1 == 1) {
